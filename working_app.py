...
app.config['SQLALCHEMY_DATABASE_URI'] = os.getenv('DATABASE_URL', 'sqlite:///agromitra.db')
...
# Import only the price prediction blueprint which we know works
from routes.price_prediction import price_bp
...
try:
    from routes.farmstories import farmstories_bp
